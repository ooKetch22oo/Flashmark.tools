...
export const BusinessCard = component$<BusinessCardProps>(({ business, website, summary }) => {
  ...
  return (
    <div class="box-border flex flex-col shrink-0 w-full rounded-lg border-t-4 border-l-4 border-solid border-b-[12px] border-r-[12px] border-slate-950 max-w-[360px]">
    <header class="box-border flex relative flex-row shrink-0 gap-1 items-center p-4 border-b-4 border-solid border-b-[black]">
        ...
        <Link href={`/profiler/${business}`}>
          <h2 class="box-border relative text-sm shrink-0 h-auto font-semibold">{business}</h2>
    </Link>
