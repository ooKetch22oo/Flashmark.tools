...
<nav class={`flex flex-row items-center w-1/3 ${isRootPath ? '' : 'hidden'}`}>        
        ...
        <Link href={`/auth/login`} class="box-border items-center ml-auto px-4 py-1 font-black flex bg-[var(--swatch--brand)] asym-borders hover:border-r-[.25rem] hover:border-b-[.25rem] cursor-pointer">
          Log In
      </Link>
      </nav>
    </header>
